...
##### USA
1. `Rscript codes/data/usa/download_and_clean_usafacts.R`: Downloads county- and state-level data from (usaifacts.org)[https://usafacts.org/visualizations/coronavirus-covid-19-spread-map/]

...
2. `python codes/plotting/figA2.py`: Generates 2 outputs that constitute ED Figure 1 (`results/figures/appendix/EDFigure1-1.pdf` and `results/figures/appendix/EDFigure1-2.pdf`)

#### Extended Data Figure 2

`Rscript codes/plotting/figA3.R`: Generates ED Figure 2 (`results/figures/appendix/EDFigure2.pdf`).

...
scraping_script <- 'codes/data/france/scrape_conf_cases_by_region.R'

# Schedule to run every day at 12pm PT (8pm in France)
...
## To delete the tasks use the following command
# taskscheduler_delete(taskname = "france_sp_conf_cases_12pm")
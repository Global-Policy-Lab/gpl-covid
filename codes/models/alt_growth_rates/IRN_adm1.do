...
foreach lags of num 0/15{ 
	...
	reghdfe D_l_cum_confirmed_cases p_1 p_2 testing_regime_*, absorb(i.adm1_id i.dow, savefe) resid
	...
	*/
	...
	preserve
	bsample
	qui reghdfe D_l_cum_confirmed_cases p_1 p_2 testing_regime_*, absorb(i.adm1_id i.dow, savefe) resid
	matrix j[`i',1] = e(r2)
	restore
	}

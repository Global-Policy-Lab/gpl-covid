...
table <- tibble(
  ...
  cumulative_confirmed_cases = str_subset(table_text, "\\d") %>% str_remove(" ")
) %>% 
...
# Output
write_csv(table, 
          paste0("C:/Users/Jeanette/GPL NZ Project Dropbox/Jeanette Tseng/GPL_covid/data/interim/france/france_confirmed_cases_by_region_", 
